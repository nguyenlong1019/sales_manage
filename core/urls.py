...
urlpatterns = [
    ...
    path('staff/price', staff_price_view, name='staff-price'),    
    path('staff/price/add', staff_add_price_view, name='staff-add-price'),    
    path('staff/price/edit/<pk:pk>', staff_edit_price_view, name='staff-edit-price'),    
    path('staff/price/delete/<pk:pk>', staff_del_price_view, name='staff-del-price'),
    path('staff/order', staff_order_view, name='staff-order'),    
    path('staff/order/add', staff_add_order_view, name='staff-add-order'),    
    path('staff/order/edit/<pk:pk>', staff_edit_order_view, name='staff-edit-order'),    
    path('staff/order/delete/<pk:pk>', staff_del_order_view, name='staff-del-order'),
    path('staff/shipping', staff_shipping_view, name='staff-shipping'),    
    path('staff/shipping/add', staff_add_shipping_view, name='staff-add-shipping'),    
    path('staff/shipping/edit/<pk:pk>', staff_edit_shipping_view, name='staff-edit-shipping'),    
    path('staff/shipping/delete/<pk:pk>', staff_del_shipping_view, name='staff-del-shipping'),
    path('staff/report', staff_report_view, name='staff-report'),    
    path('staff/report/<pk:pk>', staff_edit_report_view, name='staff-edit-report'),    
]
